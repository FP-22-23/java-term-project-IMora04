...
public class TestAccident {
	...
	public static void constructor1Test(LocalDate date, String location, Victims victims, Integer speed, Boolean escapist, Climate climate, List<String> info) {
	...
	public static void main(String[] args) {
		...
		constructor1Test(
				LocalDate.of(2010, 01, 25),
				"CANOVES I SAMALUS,Valles Oriental,Barcelona",
				new Victims(0, 1, 0),
				100,
				false,
				Climate.GOOD_WEATHER,
				new ArrayList<String>(List.of("On vacation","Urban zone","Light wind","Night","Moving vehicles collision"))
				);
		System.out.println();
		
		constructor2Test("25/01/2010,CANOVES I SAMALUS,Valles Oriental,Barcelona,0,1,0,100,No,Good weather,On vacation,Urban zone,Light wind,Night,Moving vehicles collision");
